...
- 19dcd9b: Fixed indentation error in `social.yaml` that caused YAML parse failures.

## 2.3.0

### Minor Changes

- 76628b6: ### Added 56 new UI icons
...
- 8db4b53: Adding and updating several new icons
  ...
  - `sort-down-large-to-small`
  - `sort-down-small-to-large`
  - `sort-up-large-to-small`
  - `sort-up-small-to-large`
  - `swap-right-left`
  - `swap-up-down`

  ### Updated Micron icons
  ...
  ### Deprecated icons (now aliases of their replacements)
